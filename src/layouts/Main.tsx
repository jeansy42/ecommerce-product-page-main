...
function Main() {
  const { shopingCart, showPreview } = useGlobalContext() as ContextType;
  return (
    <>
      ...
      >
        ...
        <div className="relative mb-5 sm:w-max sm:flex flex-col sm:mx-auto justify-between gap-6 ">
          <PresentationMobile d="80" t="0" aditionalCLass="sm:hidden" />
